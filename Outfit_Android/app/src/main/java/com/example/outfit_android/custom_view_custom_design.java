...
class custom_view_custom_design extends BaseAdapter {
    private Context context;
    ArrayList<String> arr1, arr2, arr3, arr4, arr5, arr6, arr7;
    Button b1;
    SharedPreferences sh;
    String url;
    public custom_view_custom_design(Context applicationContext, ArrayList<String> arg1,
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_custom_design,null);
...
//        });
        ...
        try {
            ...
            thumb_u = new java.net.URL("http://"+sh.getString("ip","")+":5000"+arr3.get(position));
//            Toast.makeText(context, "yyyyyyyyyyyyyyyy"+thumb_u, Toast.LENGTH_SHORT).show();
        ...
        tv5.setText(arr6.get(position));
        tv6.setText(arr7.get(position));
