...
class custom_view_designs extends BaseAdapter {
    private Context context;
    ArrayList<String> arr1, arr2, arr3, arr4, arr5;
    Button b1, b2;
    SharedPreferences sh;
    String url;
    public custom_view_designs(Context applicationContext, ArrayList<String> arg1,
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_designs,null);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ik = new Intent(context, view_more_images.class);
                ik.putExtra("design_id", arr5.get(position));
                context.startActivity(ik);
