...
class custom_view_materials extends BaseAdapter {
    private Context context;
    ArrayList<String> arr1, arr2, arr3, arr4, arr5, arr6;
    Button b1;
    SharedPreferences sh;
    String url, details;
    public custom_view_materials(Context applicationContext, ArrayList<String> arg1,
                               ArrayList<String> arg2, ArrayList<String> arg3,
                               ArrayList<String> arg4, ArrayList<String> arg5,
                               ArrayList<String> arg6)
    {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_materials,null);
        ...
        EditText e1 = (EditText) gridView.findViewById(R.id.editTextTextPersonName);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (details.equalsIgnoreCase("")) {
                    ...
                    e1.setError("characters not allowed");
                }else {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("success")) {
                                    ...
                                    Intent ik = new Intent(context.getApplicationContext(), user_home.class);
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put("design_id", sh.getString("d_id", ""));
                            params.put("material_id", arr6.get(position));
...
//
//
//                Intent ik = new Intent(context, update_product.class);
//                ik.putExtra("product_id", arr5.get(position));
//                context.startActivity(ik);
//
//
//            }
...
//        });
        ...
        try {
            ...
            thumb_u = new java.net.URL("http://"+sh.getString("ip","")+":5000"+arr2.get(position));
