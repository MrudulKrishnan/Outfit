...
class custom_view_user_custom_design extends BaseAdapter {
    private Context context;
    ArrayList<String> arr1, arr2, arr3, arr4, arr5;
    Button b1;
    SharedPreferences sh;
    String url;
    public custom_view_user_custom_design(Context applicationContext, ArrayList<String> arg1,
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_user_custom_design,null);
...
//        ImageView im1 = (ImageView) gridView.findViewById(R.id.imageView3);
...
//        }
        ...
        tv3.setText(arr3.get(position));
        tv4.setText(arr4.get(position));
